...
<div class="page-inner">
  <div
    ...
    <div class="ms-md-auto py-2 py-md-0">
      <a href="{{route('add_category')}}" class="btn btn-primary btn-round">Add Category</a>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-button-action">
                      <a href="{{route('edit_category',$category->name)}}"
                      ...
                      <a href="{{route('delete_category',$category->name)}}"
                        data-bs-toggle="tooltip"
                        title=""
