        ...
        <div id="data_product">
            ...
            <div id="tmp_produ" class="container-fluid">
                <div class="row">
                    <div class="col-3">
                        <div class="bdr">
                            <img src="{{asset('product_img/ea26fd_83c72897dbd54a3fb32675df14ec63a9~mv2_d_1920_1920_s_2.png')}}">
                            <span>Im Product</span>
                            <br>
                            Rp. 90
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="bdr">
                            <img src="{{asset('product_img/1727250123.png')}}">
                            <span>Im Product</span>
                            <br>
                            Rp. 90
                        </div>
                    ...
                    <div class="col-3">
                        <div class="bdr">
                            <img src="{{asset('product_img/1727250244.png')}}">
                            <span>Im Product</span>
                            <br>
                            Rp. 90
                        </div>
                    ...
                    <div class="col-3">
                        <div class="bdr">
                            <img src="{{asset('product_img/ea26fd_497ef8464b404d6c9a3b4c954242bb56~mv2_d_1920_1920_s_2.png')}}">
                            <span>Im Product</span>
                            <br>
                            Rp. 90
                        </div>
